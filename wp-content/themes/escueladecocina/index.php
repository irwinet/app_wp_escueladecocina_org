        ...
        <div class="row justify-content-center">
            <blockquote class="subtitulo text-center pl-3">
                <?php
                    ...
                    echo get_post_meta($id_blog, 'edc_blog_slogn_blog', true);
                ?>
            </blockquote>
        </div>
    </div>
                    ...
                    <div class="row entrada mb-4">
                        ...
                        <div class="col-md-8">
                            <div class="contenido-entrada pt-4 pt-md-0">
                                ...
                                ?> 
                                <p><?php the_excerpt(); ?></p>
                                <a href="<?php the_permalink(); ?>" class="btn btn-primary text-light">
                                    Ver Entrada
                                </a>
                            </div>
                        </div>
